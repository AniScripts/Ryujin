...
class SpedupCog(RyujinCog):
    ...
    @nextcord.slash_command(name="spedup", description="Converts an uploaded audio file into a Sped Up version.")
    async def spedup_command(self, interaction: nextcord.Interaction, song: nextcord.Attachment):
