...
class SlowedCog(RyujinCog):
    def __init__(self, bot):
        self.bot = bot

    @app_commands.command(name="slowed", description="Converts an uploaded audio file into a Slowed version.")
    async def slowed_command(self, interaction: discord.Interaction, song: discord.Attachment):
...
async def setup(bot):
    await bot.add_cog(SlowedCog(bot))
